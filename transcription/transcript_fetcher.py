...
def fetch_transcript(video: dict, output_dir: str, languages: list[str]) -> None:
    ...
    if os.path.exists(out_path):
        print(f"  Already exists, skipping: {vid_id}\n")
        return
    ...
    try:
        ...
        print(f"  Skipped {vid_id}: transcripts disabled.\n")
    except NoTranscriptFound:
        print(f"  Skipped {vid_id}: no transcript in {languages}.\n")
...
def main():
    ...
    print("-" * 60)
    print(f"Done. Transcripts in '{output_dir}/'")
